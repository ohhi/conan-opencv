...
if __name__ == "__main__":
    ...
    if platform.system() == "Windows":
        ...
        system('conan create . jilab/stable -s build_type=Release -o OpenCV:shared=False %s' % params)
        system('conan create . jilab/stable -s build_type=Debug -o OpenCV:shared=False %s' % params)
        system('conan create . jilab/stable -s build_type=Release -o OpenCV:shared=True %s' % params)
        system('conan create . jilab/stable -s build_type=Debug -o OpenCV:shared=True %s' % params)
